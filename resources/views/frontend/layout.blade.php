...
<html>
  <head>
    <meta charset="utf-8">
    <title>@yield('title','Cinema Master')</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
    <!-- Bootstrap -->
    <link href="css/frontend/bootstrap.css" rel="stylesheet">
    <link href="css/frontend/bootstrap-responsive.css" rel="stylesheet">
  ...
  <div id="header-row">
    <div class="container">
      <div class="row">
              <!--LOGO-->
              <div class="span3"><a class="brand" href="#"><img src="" alt="logo"/></a></div>
              <!-- /LOGO -->
